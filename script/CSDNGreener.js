`
🤖 本脚本转换自：https://greasyfork.org/scripts/378351-持续更新-csdn广告完全过滤-人性化脚本优化-不用再登录了-让你体验令人惊喜的崭新csdn/code/🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js。
...
🔘 Quantumult X
[rewrite_local]
.*\.csdn\.net/.* url script-response-body 🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js


🔘 Loon
[Script]
http-response .*\.csdn\.net/.* script-path=🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js, requires-body=true, tag=🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js


🔘 Surge
[Script]
🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js=type=http-response, pattern=.*\.csdn\.net/.*, script-path=🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js, requires-body=true, max-size=1310720
...
try {
    ...
    if (/<\/html>|<\/body>/.test(body)) {
        body = body.replace('</body>', `<script src=https://cdn.jsdelivr.net/npm/jquery.cookie/jquery.cookie.js></script>
...
function getHeight(element) {
    ...
    return outerHeight;
        ...
        console.log("[油猴脚本] 🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js 注入成功!");
    }
    $done({body});
} catch (err) {
    console.log("[油猴脚本] 🔥持续更新🔥 CSDN广告完全过滤、人性化脚本优化：🆕 不用再登录了！让你体验令人惊喜的崭新CSDN。.user.js 执行失败!\n" + err);
    $done({});
}
